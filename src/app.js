...
var gameScene = cc.Scene.extend({
    onEnter:function () {
      ...
      label1 = cc.Sprite.create(res.lv1);
...
var game = cc.Layer.extend({
    init:function () {
        ...
        this.addBody(240,140,24,28,true,res.ball_png,SpriteTag.totem);
        this.addBody(240,10,480,20,false,res.ground_png,SpriteTag.ground);
        this.addBody(204,200,150,60,false,res.kusa2,SpriteTag.destroyable);
        this.addBody(330,200,150,60,false,res.kusa2,SpriteTag.destroyable);
        //this.addBody(250,200,24,24,false,res.kusa1,SpriteTag.destroyable);
        this.addBody(330,250,35,44,false,res.pika,SpriteTag.target);
        this.addBody(10,96,60,150,false,res.ki,SpriteTag.destroyable);
        this.addBody(10,240,48,24,false,res.ki,SpriteTag.destroyable);
        this.addBody(240,45,96,48,false,res.brick4x2_png,SpriteTag.solid);
